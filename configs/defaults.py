...
def add_dataset_config(cfg):
  ...
  # Synthetic Genome Dataset Configuration
  _C.DATASETS.SYNTHETIC_GENOME = CN()
  _C.DATASETS.SYNTHETIC_GENOME.IMAGES = ''
  _C.DATASETS.SYNTHETIC_GENOME.MAPPING_DICTIONARY = ''
  _C.DATASETS.SYNTHETIC_GENOME.IMAGE_DATA = ''
  _C.DATASETS.SYNTHETIC_GENOME.SG_TRAIN_DATA = ''
  _C.DATASETS.SYNTHETIC_GENOME.SG_VAL_DATA = ''
  _C.DATASETS.SYNTHETIC_GENOME.SG_MAPPER = ''
  _C.DATASETS.SYNTHETIC_GENOME.SYNTHETIC_ATTRIBUTE_H5 = ''
  _C.DATASETS.SYNTHETIC_GENOME.TRAIN_MASKS = ""
  _C.DATASETS.SYNTHETIC_GENOME.TEST_MASKS = ""
  _C.DATASETS.SYNTHETIC_GENOME.VAL_MASKS = ""
  _C.DATASETS.SYNTHETIC_GENOME.CLIPPED = False
  _C.DATASETS.SYNTHETIC_GENOME.PER_CLASS_DATASET = False
  _C.DATASETS.SYNTHETIC_GENOME.BGNN = False
  _C.DATASETS.SYNTHETIC_GENOME.FILTER_EMPTY_RELATIONS = True
  _C.DATASETS.SYNTHETIC_GENOME.FILTER_DUPLICATE_RELATIONS = True
  _C.DATASETS.SYNTHETIC_GENOME.FILTER_NON_OVERLAP = True
  _C.DATASETS.SYNTHETIC_GENOME.EXCLUDE_LEFT_RIGHT = False
  _C.DATASETS.SYNTHETIC_GENOME.NUMBER_OF_VALIDATION_IMAGES = 5000
  _C.DATASETS.SYNTHETIC_GENOME.BOX_SCALE = 1024
  _C.DATASETS.SYNTHETIC_GENOME.MAX_NUM_RELATIONS = -1
  _C.DATASETS.SYNTHETIC_GENOME.MAX_NUM_OBJECTS = -1
  _C.DATASETS.SYNTHETIC_GENOME.UNDERSAMPLE_PARAM = 0.7
  _C.DATASETS.SYNTHETIC_GENOME.OVERSAMPLE_PARAM = 0.07
  _C.DATASETS.SYNTHETIC_GENOME.CORRUPTED_IMAGES = []

  # Multi-Dataset Configuration (Visual Genome + Synthetic)
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC = CN()
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.IMAGES = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.MAPPING_DICTIONARY = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.IMAGE_DATA = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.SG_TRAIN_DATA = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.SG_VAL_DATA = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.SG_MAPPER = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.VG_ATTRIBUTE_H5 = ''
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.TRAIN_MASKS = ""
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.TEST_MASKS = ""
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.VAL_MASKS = ""
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.CLIPPED = False
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.PER_CLASS_DATASET = False
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.BGNN = False
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.FILTER_EMPTY_RELATIONS = True
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.FILTER_DUPLICATE_RELATIONS = True
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.FILTER_NON_OVERLAP = True
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.EXCLUDE_LEFT_RIGHT = False
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.NUMBER_OF_VALIDATION_IMAGES = 5000
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.BOX_SCALE = 1024
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.MAX_NUM_RELATIONS = -1
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.MAX_NUM_OBJECTS = -1
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.UNDERSAMPLE_PARAM = 0.7
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.OVERSAMPLE_PARAM = 0.07
  _C.DATASETS.VISUAL_GENOME_SYNTHETIC.CORRUPTED_IMAGES = []

  # Multi-Dataset Training Configuration
  _C.DATASETS.MULTI_DATASET = CN()
  _C.DATASETS.MULTI_DATASET.ENABLED = False
  _C.DATASETS.MULTI_DATASET.REAL_SAMPLING_RATIO = 0.7
  _C.DATASETS.MULTI_DATASET.SYNTHETIC_SAMPLING_RATIO = 0.3
  _C.DATASETS.MULTI_DATASET.REAL_LOSS_WEIGHT = 1.0
  _C.DATASETS.MULTI_DATASET.SYNTHETIC_LOSS_WEIGHT = 0.5
